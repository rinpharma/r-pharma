...
for (i in unique(d_workshops$event)) {
  ...
  bottom_txt <- paste(
    '\n\n---\n',
    'R/Pharma is excited to present a total of 20 workshops this year, hosted by members of our community.  Zoom links will be sent to workshop attendees a couple of days before the workshop.\n',
